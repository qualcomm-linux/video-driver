...
static u32 msm_vidc_encoder_output_size_ar50lt(struct msm_vidc_inst *inst)
{
	u32 frame_size;
	u32 mbs_per_frame;
	u32 width, height;
	...
	else if (inst->capabilities[CONTENT_ADAPTIVE_CODING].value ==
		...
		enum msm_vidc_buffer_type buffer_type)
{
	...
	static const struct msm_vidc_buf_type_handle enc_buf_type_handle[] = {
		...
		{MSM_VIDC_BUF_OUTPUT,          msm_vidc_encoder_output_size_ar50lt      },
