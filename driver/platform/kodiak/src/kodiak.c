...
static struct codec_info codec_data_kodiak[] = {
	{
...
static struct color_format_info color_format_data_kodiak[] = {
	{
...
static struct color_primaries_info color_primaries_data_kodiak[] = {
	{
...
static struct transfer_char_info transfer_char_data_kodiak[] = {
	{
...
static struct matrix_coeff_info matrix_coeff_data_kodiak[] = {
	{
...
static const struct msm_platform_core_capability core_data_kodiak_v0[] = {
	/* {type, value} */
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_kodiak[] = {
	/* {cap, domain, codec,
	 *      children,
	 *      adjust, set}
	 */
...
static struct msm_vidc_format_capability format_data_kodiak = {
	...
	.codec_info_size = ARRAY_SIZE(codec_data_kodiak),
	.color_format_info = color_format_data_kodiak,
	.color_format_info_size = ARRAY_SIZE(color_format_data_kodiak),
	.color_prim_info = color_primaries_data_kodiak,
	.color_prim_info_size = ARRAY_SIZE(color_primaries_data_kodiak),
	.transfer_char_info = transfer_char_data_kodiak,
	.transfer_char_info_size = ARRAY_SIZE(transfer_char_data_kodiak),
	.matrix_coeff_info = matrix_coeff_data_kodiak,
	.matrix_coeff_info_size = ARRAY_SIZE(matrix_coeff_data_kodiak),
};

/* name, min_kbps, max_kbps */
static const struct bw_table kodiak_bw_table[] = {
	{ "cpu-cfg", 1000, 1000     },
	{ "video-mem", 1000, 10000000 }
};

/* name */
static struct pd_table kodiak_pd_table[] = {
	{ "venus",     0, 1 },
	{ "vcodec0",   1, 1 },
};

/* name */
static const char * const kodiak_opp_pd_table[] = { "cx", NULL };
...
const struct context_bank_table kodiak_context_bank_table[] = {
	{"qcom,sc7280-venus", 0x25800000, 0x0,        0, 1, MSM_VIDC_NON_SECURE |
							    MSM_VIDC_NON_SECURE_BITSTREAM |
							    MSM_VIDC_NON_SECURE_PIXEL,
							    0xe0000000 - 1},
	{"qcom,sc7280-venus", 0x01000000, 0x24800000, 1, 0, MSM_VIDC_SECURE_NONPIXEL,
							    0},
};

/* register, value, mask */
static const struct reg_preset_table kodiak_reg_preset_table[] = {
	{ 0xB0088, 0x0,        0x11      },
};

/* decoder properties */
static const u32 kodiak_vdec_psc_avc[] = {
...
static const u32 kodiak_vdec_psc_hevc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 kodiak_vdec_psc_vp9[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 kodiak_vdec_input_properties_avc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 kodiak_vdec_input_properties_hevc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 kodiak_vdec_input_properties_vp9[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 kodiak_vdec_output_properties_avc[] = {
...
static const u32 kodiak_vdec_output_properties_hevc[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
};

static const u32 kodiak_vdec_output_properties_vp9[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
};

static const u32 kodiak_msm_vidc_ssr_type[] = {
	HFI_SSR_TYPE_SW_ERR_FATAL,
};

static struct msm_vidc_efuse_data efuse_data_kodiak[] = {
	/* IRIS_PLL_FMAX - max 4k@30 encode */
	EFUSE_ENTRY(0x221C8118, 4, 0x100, 0x8, SKU_VERSION),
};

static const struct msm_vidc_platform_data kodiak_data_v0 = {
	/* resources dependent on other module */
	.bw_tbl = kodiak_bw_table,
	.bw_tbl_size = ARRAY_SIZE(kodiak_bw_table),
	.pd_tbl = kodiak_pd_table,
	.pd_tbl_size = ARRAY_SIZE(kodiak_pd_table),
	.opp_tbl = kodiak_opp_pd_table,
	.opp_tbl_size = ARRAY_SIZE(kodiak_opp_pd_table),
	.clk_tbl = kodiak_clk_table,
	.clk_tbl_size = ARRAY_SIZE(kodiak_clk_table),

	/* populate context bank */
	.context_bank_tbl = kodiak_context_bank_table,
	.context_bank_tbl_size = ARRAY_SIZE(kodiak_context_bank_table),

	/* platform specific resources */
	.reg_prst_tbl = kodiak_reg_preset_table,
	.reg_prst_tbl_size = ARRAY_SIZE(kodiak_reg_preset_table),
	...
	.core_data = core_data_kodiak_v0,
	.core_data_size = ARRAY_SIZE(core_data_kodiak_v0),
	.inst_cap_data = instance_cap_data_kodiak_v0,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_kodiak_v0),
	.inst_cap_dependency_data = instance_cap_dependency_data_kodiak,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_kodiak),
	...
	.psc_avc_tbl = kodiak_vdec_psc_avc,
	.psc_avc_tbl_size = ARRAY_SIZE(kodiak_vdec_psc_avc),
	.psc_hevc_tbl = kodiak_vdec_psc_hevc,
	.psc_hevc_tbl_size = ARRAY_SIZE(kodiak_vdec_psc_hevc),
	.psc_vp9_tbl = kodiak_vdec_psc_vp9,
	.psc_vp9_tbl_size = ARRAY_SIZE(kodiak_vdec_psc_vp9),
	.dec_input_prop_avc = kodiak_vdec_input_properties_avc,
	.dec_input_prop_hevc = kodiak_vdec_input_properties_hevc,
	.dec_input_prop_vp9 = kodiak_vdec_input_properties_vp9,
	.dec_input_prop_size_avc = ARRAY_SIZE(kodiak_vdec_input_properties_avc),
	.dec_input_prop_size_hevc = ARRAY_SIZE(kodiak_vdec_input_properties_hevc),
	.dec_input_prop_size_vp9 = ARRAY_SIZE(kodiak_vdec_input_properties_vp9),
	.dec_output_prop_avc = kodiak_vdec_output_properties_avc,
	.dec_output_prop_hevc = kodiak_vdec_output_properties_hevc,
	.dec_output_prop_vp9 = kodiak_vdec_output_properties_vp9,
	.dec_output_prop_size_avc = ARRAY_SIZE(kodiak_vdec_output_properties_avc),
	.dec_output_prop_size_hevc = ARRAY_SIZE(kodiak_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 = ARRAY_SIZE(kodiak_vdec_output_properties_vp9),

	//.msm_vidc_ssr_type = kodiak_msm_vidc_ssr_type,
	//.msm_vidc_ssr_type_size = ARRAY_SIZE(kodiak_msm_vidc_ssr_type),
	.efuse_data = efuse_data_kodiak,
...
{
	d_vpr_h("%s: initialize kodiak data\n", __func__);
	core->platform->data = kodiak_data_v0;
...
int msm_vidc_init_platform_kodiak(struct msm_vidc_core *core)
{
	...
	d_vpr_h("%s: initialize kodiak ops\n", __func__);
